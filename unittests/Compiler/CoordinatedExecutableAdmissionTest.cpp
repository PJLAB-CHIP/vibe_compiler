//===- CoordinatedExecutableAdmissionTest.cpp --------------------------===//

#include "../../lib/Wafer/Compiler/CoordinatedExecutableAdmission.h"
...
class CoordinatedExecutableAdmissionTest : public ::testing::Test {
protected:
  CoordinatedExecutableAdmissionTest() {
...
TEST_F(CoordinatedExecutableAdmissionTest,
  ...
  auto accepted = wafer::compiler::detail::admitCoordinatedExecutable(
      std::move(ranks), selectedTileIR,
      wafer::compiler::detail::CoordinatedScheduleActionIdentity{},
      emptyProgram(), *config, diagnostics, &failureGate, &statistics);

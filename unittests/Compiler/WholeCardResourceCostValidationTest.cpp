//===- WholeCardResourceCostValidationTest.cpp ---------------------------===//
...
class WholeCardResourceCostValidationTest : public ::testing::Test {
protected:
  WholeCardResourceCostValidationTest() {
...
TEST_F(WholeCardResourceCostValidationTest,
...
module {
  ...
  auto accepted =
      wafer::compiler::testing::validateWholeCardResourceCost(modules, *config);
...
module {
  ...
  EXPECT_TRUE(
      mlir::failed(wafer::compiler::testing::validateWholeCardResourceCost(
          modules, *config)));
}
...
module {
  ...
  auto accepted = wafer::compiler::testing::validateWholeCardResourceCost(
      modules, *cardConfig);
  ASSERT_TRUE(mlir::succeeded(accepted));

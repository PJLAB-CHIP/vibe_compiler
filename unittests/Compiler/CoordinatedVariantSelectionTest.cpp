...
using wafer::compiler::detail::CoordinatedQualificationSelectionPlan;
...
TEST(CoordinatedVariantSelectionTest, DecisionIsIndependentOfAdmissionOrder) {
  WholeCardInstructionProgramCost baseline = makeCost(1'000'000'000);
...
protected:
  ...
  wafer::compiler::detail::AdmittedCoordinatedExecutable
  makeExecutable(int64_t semanticOrdinal, uint32_t actionOrdinal,
    ...
    wafer::compiler::detail::AcceptedWholeVariant accepted(
        std::move(ranks), std::move(launch),
        wafer::analysis::WholeCardInstructionProgramCost{});
    return wafer::compiler::detail::AdmittedCoordinatedExecutable(
        semanticOrdinal, reservedBaseline, std::move(accepted), actionOrdinal,
        wafer::compiler::detail::CoordinatedScheduleActionIdentity{},
...
TEST_F(CoordinatedQualificationSelectionTest,
  ...
  std::vector<wafer::compiler::detail::AdmittedCoordinatedExecutable> variants;
  ...
  mlir::FailureOr<CoordinatedQualificationSelectionPlan> selected =
      wafer::compiler::detail::planCoordinatedQualificationSelection(
...
TEST_F(CoordinatedQualificationSelectionTest,
  ...
  mlir::FailureOr<wafer::compiler::detail::AdmittedCoordinatedExecutable>
      winner = wafer::compiler::detail::selectAdmittedCoordinatedExecutable(
          std::move(variants),
...
TEST_F(CoordinatedQualificationSelectionTest,
       QualificationFrontierReductionDoesNotApplyProductionCostPromotion) {
  std::vector<wafer::compiler::detail::AdmittedCoordinatedExecutable> variants;
  variants.push_back(makeExecutable(
      /*semanticOrdinal=*/0, /*actionOrdinal=*/0,
      /*reservedBaseline=*/true, "all_gather_ring"));
  ...
  ASSERT_TRUE(
      mlir::succeeded(wafer::compiler::detail::reduceAdmittedExecutableFrontier(
          variants, WholeVariantSelectionMode::CharacterizeAllGatherDirect)));

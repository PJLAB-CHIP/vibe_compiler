//===- WholeCardResourceVerificationTest.cpp ------------------------------===//
...
class WholeCardResourceVerificationTest : public ::testing::Test {
protected:
  WholeCardResourceVerificationTest() {
...
module {
  ...
  verifyResources(llvm::ArrayRef<mlir::ModuleOp> modules,
    ...
    return wafer::compiler::testing::verifyWholeCardResources(
...
TEST_F(WholeCardResourceVerificationTest,
       VerifiesExactResourceSummaryForCompletePhysicalTileDomain) {
...
TEST_F(WholeCardResourceVerificationTest, AccountsDirectCallClosureFromEntry) {
  auto module = parse(R"mlir(
module {
  func.func @main() {
    func.call @helper() : () -> ()
...
TEST_F(WholeCardResourceVerificationTest, ModelsRouteWorkFromPhysicalTopology) {
...
module {
  ...
  EXPECT_TRUE(mlir::failed(wafer::compiler::testing::verifyWholeCardResources(

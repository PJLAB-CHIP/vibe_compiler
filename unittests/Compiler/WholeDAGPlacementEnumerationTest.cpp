//===- WholeDAGPlacementEnumerationTest.cpp -------------------------------===//

#include "../../lib/Wafer/Compiler/WholeDAGPlacementEnumeration.h"
...
class WholeDAGPlacementEnumerationTest : public ::testing::Test {
protected:
  WholeDAGPlacementEnumerationTest() {
...
module {
  ...
  derive(mlir::ModuleOp module, WholeDAGPlacementEnumerationStatistics &stats) {
    std::string failureReason;
    ...
    auto candidates = enumerateWholeDAGPlacements(
...
TEST_F(WholeDAGPlacementEnumerationTest,
...
TEST_F(WholeDAGPlacementEnumerationTest,
  ...
  ASSERT_TRUE(module);
  WholeDAGPlacementEnumerationStatistics firstStats;
  auto first = derive(*module, firstStats);
  WholeDAGPlacementEnumerationStatistics secondStats;

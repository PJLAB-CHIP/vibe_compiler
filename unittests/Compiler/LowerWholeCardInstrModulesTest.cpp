//===- LowerWholeCardInstrModulesTest.cpp --------------------------===//

#include "../../lib/Wafer/Compiler/LowerWholeCardInstrModules.h"
...
class LowerWholeCardInstrModulesTest : public ::testing::Test {
protected:
  LowerWholeCardInstrModulesTest() {
...
TEST_F(LowerWholeCardInstrModulesTest,
  ...
  auto accepted = wafer::compiler::detail::lowerWholeCardInstrModules(
      std::move(ranks), selectedTileIR,
      wafer::compiler::detail::WholeCardScheduleActionKey{}, emptyProgram(),
...
module {
  func.func @main()
    ...
    wafer::compiler::RankExecutable rank =
        wafer::compiler::PhysicalTileExecutablesBuilder::makeRank(

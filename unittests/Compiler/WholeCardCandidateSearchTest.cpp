//===- WholeCardCandidateSearchTest.cpp ---------------------------------===//

#include "../../lib/Wafer/Compiler/WholeCardCandidateSearch.h"
...
class WholeCardCandidateSearchTest : public ::testing::Test {
protected:
  WholeCardCandidateSearchTest() {
...
TEST_F(WholeCardCandidateSearchTest,
...
TEST_F(WholeCardCandidateSearchTest,
  ...
  auto ledger = wafer::compiler::detail::CoordinatedWorkLedger::create(
      /*rankCount=*/4);
  ASSERT_TRUE(mlir::succeeded(ledger));
  wafer::compiler::detail::WholeCardCandidateSearchConfig config;
  config.rankCount = 4;
  auto candidates = wafer::compiler::detail::buildWholeCardTileCandidateSet(
  ...
  for (const auto &variant : *candidates) {
    ...
    EXPECT_EQ(variant.candidateSetDigest,
              wafer::compiler::detail::computeWholeCardTileCandidateSetDigest(
                  *candidates));
  }
...
TEST_F(WholeCardCandidateSearchTest,
  ...
  auto session =
      wafer::compiler::detail::WholeCardCandidateSearchSession::create(
...
TEST_F(WholeCardCandidateSearchTest,
  ...
  wafer::compiler::detail::WholeCardCandidateSearchConfig serial;
  serial.rankCount = 4;
  ...
  wafer::compiler::detail::StructuredCandidateSearchStatistics
      parallelStatistics;
  auto first = wafer::compiler::detail::buildWholeCardTileCandidateSet(
      *firstSource, serial, *firstLedger, &serialStatistics);
  auto second = wafer::compiler::detail::buildWholeCardTileCandidateSet(
  ...
  EXPECT_EQ(
      wafer::compiler::detail::computeWholeCardTileCandidateSetDigest(*first),
      wafer::compiler::detail::computeWholeCardTileCandidateSetDigest(*second));
}

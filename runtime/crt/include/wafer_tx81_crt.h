...
uint64_t wafer_tx81_direct_dte_multisend_prepare(
    ...
    uint32_t destination_count, uint32_t kind, uint32_t is_high_performance);
void wafer_tx81_direct_dte_multisend_add_destination(uint64_t event,
                                                     uint64_t remote_dst,
...
void wafer_tx81_elementwise_abs(uint64_t src, uint64_t dst,
                                   uint32_t elem_count, uint32_t format,
                                   uint32_t worker);
...
void wafer_tx81_elementwise_rsqrt(uint64_t src, uint64_t dst,
                                     uint32_t elem_count, uint32_t format,
                                     uint32_t worker);
void wafer_tx81_elementwise_neg(uint64_t src, uint64_t dst,
                                   uint32_t elem_count, uint32_t format,
                                   uint32_t worker);
...
void wafer_tx81_elementwise_logic_not(uint64_t src, uint64_t dst,
                                         uint32_t elem_count, uint32_t format,
                                         uint32_t worker);
void wafer_tx81_elementwise_logic_and(uint64_t lhs, uint64_t rhs,
                                         uint64_t dst, uint32_t elem_count,
                                         uint32_t format, uint32_t worker);
void wafer_tx81_elementwise_logic_or(uint64_t lhs, uint64_t rhs,
                                        uint64_t dst, uint32_t elem_count,
                                        uint32_t format, uint32_t worker);
void wafer_tx81_elementwise_logic_xor(uint64_t lhs, uint64_t rhs,
                                         uint64_t dst, uint32_t elem_count,
                                         uint32_t format, uint32_t worker);
void wafer_tx81_elementwise_log2(uint64_t src, uint64_t dst,
                                    uint32_t elem_count, uint32_t format,
                                    uint32_t worker);
void wafer_tx81_elementwise_ln(uint64_t src, uint64_t dst,
                                  uint32_t elem_count, uint32_t format,
                                  uint32_t worker);
void wafer_tx81_elementwise_pow2(uint64_t src, uint64_t dst,
                                    uint32_t elem_count, uint32_t format,
                                    uint32_t worker);
void wafer_tx81_elementwise_exp(uint64_t src, uint64_t dst,
                                   uint32_t elem_count, uint32_t format,
                                   uint32_t worker);
void wafer_tx81_elementwise_exp_lp(uint64_t src, uint64_t dst,
                                      uint32_t elem_count, uint32_t format,
                                      uint32_t worker);
void wafer_tx81_elementwise_sin(uint64_t src, uint64_t dst,
                                   uint32_t elem_count, uint32_t format,
                                   uint32_t worker);
void wafer_tx81_elementwise_cos(uint64_t src, uint64_t dst,
                                   uint32_t elem_count, uint32_t format,
                                   uint32_t worker);
...
void wafer_tx81_reduce_sum(uint64_t src, uint64_t dst, uint32_t dim,
                              uint32_t n, uint32_t h, uint32_t w, uint32_t c,
                              uint32_t format, uint32_t worker);
void wafer_tx81_reduce_max(uint64_t src, uint64_t dst, uint32_t dim,
                              uint32_t n, uint32_t h, uint32_t w, uint32_t c,
                              uint32_t format, uint32_t worker);
void wafer_tx81_reduce_min(uint64_t src, uint64_t dst, uint32_t dim,
                              uint32_t n, uint32_t h, uint32_t w, uint32_t c,
                              uint32_t format, uint32_t worker);
void wafer_tx81_reduce_avg(uint64_t src, uint64_t dst, uint32_t dim,
                              uint32_t n, uint32_t h, uint32_t w, uint32_t c,
                              uint32_t format, uint32_t worker);
...
void wafer_tx81_pool_sum(
    uint64_t input, uint64_t dst, uint32_t kind, uint32_t src_n, uint32_t src_h,
    uint32_t src_w, uint32_t src_c, uint32_t dst_n, uint32_t dst_h,
    uint32_t dst_w, uint32_t dst_c, uint32_t pad_top, uint32_t pad_bottom,
    uint32_t pad_left, uint32_t pad_right, uint32_t kernel_x, uint32_t kernel_y,
    uint32_t stride_x, uint32_t stride_y, uint32_t format, uint32_t worker);
void wafer_tx81_pool_max(
    uint64_t input, uint64_t dst, uint32_t kind, uint32_t src_n, uint32_t src_h,
    uint32_t src_w, uint32_t src_c, uint32_t dst_n, uint32_t dst_h,
    uint32_t dst_w, uint32_t dst_c, uint32_t pad_top, uint32_t pad_bottom,
    uint32_t pad_left, uint32_t pad_right, uint32_t kernel_x, uint32_t kernel_y,
...
void wafer_tx81_peripheral_lut32(uint64_t src, uint64_t lut, uint64_t dst,
                                    ...
                                    uint32_t scale, uint32_t probability,
                                    uint32_t rounding_mode, uint32_t worker);
void wafer_tx81_peripheral_rand_gen(uint64_t src0, uint64_t src1,

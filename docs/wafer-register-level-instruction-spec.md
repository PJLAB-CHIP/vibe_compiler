...
Wafer唯一current package以顶层`kind=model`和nested `entry_abi=tx81-model-bootparam`
表达此路径；它现已由typed graph record、ordinal verifier、checked allocation/lifetime、module identity、

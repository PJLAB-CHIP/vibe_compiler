...
module {
  func.func @tensor_layout_spm_handoff(
    ...
    ^bb0(%unused_boundary: memref<1xf16, #wafer.memory<ddr, tensor>>):
    ...
    %done = wafer.tile.region(%resident, %boundary
        : memref<1x2x4xf16, #wafer.memory<spm, tensor>>,
          memref<1xf16, #wafer.memory<ddr, tensor>>) ->
        (memref<1xf16, #wafer.memory<ddr, tensor>>) {
    ^bb0(%input: memref<1x2x4xf16, #wafer.memory<spm, tensor>>,
         %ddr: memref<1xf16, #wafer.memory<ddr, tensor>>):

// RUN: wafer-opt --wafer-lower-ring-reduce-collectives --wafer-lower-tile-region-to-c-abi %s | FileCheck %s
...
// CHECK: wafer.abi.dte_recv %{{.*}} {bytes = 16 : i64, fsm_id = 1 : i64, packet_id = 1 : i64, peer = 1 : i64, slot = 0 : i64, stream_id = 1 : i64}

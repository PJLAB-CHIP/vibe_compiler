...
module {
  ...
  func.func @all_gather_ring(%boundary: memref<16xf32, #wafer.memory<ddr, tensor>>) {
...
// CHECK-LABEL: func.func @all_gather_ring
// CHECK-SAME: %[[BOUNDARY:[^:]+]]:
...
// SPM: %[[LOCAL:.+]] = memref.alloc() {wafer.spm.offset = #wafer.spm_offset<
// SPM-SAME: memref<4xf32, #wafer.memory<spm, tensor>>
// SPM: %[[GATHER:.+]] = memref.alloc() {wafer.spm.offset = #wafer.spm_offset<
// SPM-SAME: memref<16xf32, #wafer.memory<spm, tensor>>

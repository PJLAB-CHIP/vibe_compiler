...
func.func @local_drain_extends_prior_local_write(
...
// CHECK-LABEL: func.func @local_drain_extends_prior_local_write
...
func.func @branch_local_drains_clear_covered_write(
...
// CHECK-LABEL: func.func @branch_local_drains_clear_covered_write

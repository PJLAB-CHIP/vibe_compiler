...
module {
  func.func @abi_skeleton(
    ...
    wafer.abi.wdma_1d <issue_only> %mm_t, %out
        {bytes = 128 : i64}
        : !wafer.tile_buffer<tensor<4x16xf16>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
       -> tensor<4x16xf16>
    return
...
// CHECK: wafer.abi.rdma_1d <issue_only>
// CHECK-SAME: bytes = 64 : i64
// CHECK: wafer.abi.gemm <issue_only>
// CHECK-SAME: k = 8 : i64
// CHECK-SAME: m = 4 : i64
// CHECK-SAME: n = 16 : i64
// CHECK: wafer.abi.wdma_1d <issue_only>

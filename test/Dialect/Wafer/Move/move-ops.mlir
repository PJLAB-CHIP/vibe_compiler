...
module {
  ...
  %inserted = wafer.move.insert_slice %slice into %wide
      {offsets = array<i64: 2>, sizes = array<i64: 4>, strides = array<i64: 1>}
      : !wafer.tile_buffer<tensor<4xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
       into !wafer.tile_buffer<tensor<8xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
     -> !wafer.tile_buffer<tensor<8xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
  %matrix = "builtin.unrealized_conversion_cast"()
      : () -> !wafer.tile_buffer<tensor<2x4xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
  ...
  %row_inserted = wafer.move.insert_slice %row into %matrix
      ...
      : !wafer.tile_buffer<tensor<4xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
       into !wafer.tile_buffer<tensor<2x4xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
     -> !wafer.tile_buffer<tensor<2x4xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
  %copy = wafer.move.copy %patch
      : !wafer.tile_buffer<tensor<4xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
     -> !wafer.tile_buffer<tensor<4xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>
  %transposed = "builtin.unrealized_conversion_cast"()
      : () -> !wafer.tile_buffer<tensor<3x2xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>

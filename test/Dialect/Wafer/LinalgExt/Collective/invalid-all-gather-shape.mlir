...
func.func @invalid_all_gather_shape(
    %input: tensor<2x4xf32>) -> tensor<7x4xf32> {
  %out = tensor.empty() : tensor<7x4xf32>
  // CHECK: all_gather result dimension along axis must equal input dimension times partition_group size

...
func.func @invalid_attention_semantics_mix(
    %query: tensor<2x3x4xf16>, %key: memref<2x5x4xf16>,
    %value: tensor<2x5x6xf16>, %scale: f16) -> tensor<2x3x6xf16> {
  %out = tensor.empty() : tensor<2x3x6xf16>
  // CHECK: cannot mix tensor and buffer semantics
  %result = wafer.linalg_ext.attention
      ins(%query, %key, %value, %scale :
          tensor<2x3x4xf16>, memref<2x5x4xf16>, tensor<2x5x6xf16>, f16)

...
func.func @invalid_physical_buffer(
    %input: !wafer.tile_buffer<tensor<2x4xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>,
  ...
  %0 = wafer.tensor_collective.all_gather
      ins(%input : !wafer.tile_buffer<tensor<2x4xf32>, #wafer.mem_layout<tensor>, #wafer.memory_space<spm>>)

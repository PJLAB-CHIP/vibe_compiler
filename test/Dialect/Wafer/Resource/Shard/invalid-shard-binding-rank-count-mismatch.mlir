...
module {
  func.func @forward(%arg0: tensor<1x4xf32>, %arg1: tensor<1x4xf32>) {
    return
  }
...
// CHECK: shard binding logical rank count {{[0-9]+}} does not match existing shard binding logical rank count {{[0-9]+}}

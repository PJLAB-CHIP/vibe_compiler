...
import wafer_board_ddr_tile_offset_probe_runner as ddr_tile
import wafer_board_ncc_execution_probe_runner as ncc
import wafer_board_spm_cross_tile_conflict_probe_runner as spm_tile
...
def _validate_existing_bindings() -> None:
    ...
    modules = {
        "test/Board/Support/wafer_board_ncc_execution_probe_runner.py": ncc,
        ...
        "test/Board/Support/wafer_board_ddr_tile_offset_probe_runner.py": ddr_tile,
    }
...
def _validate_cli(repo: pathlib.Path) -> None:
    ...
    script = (
        repo
        / "test/Board/Support/wafer_worker_memory_contention_characterization_driver.py"
    )

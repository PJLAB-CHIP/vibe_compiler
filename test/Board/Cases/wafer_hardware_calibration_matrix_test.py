...
def validate_operator_payload_dtypes(
    ...
    collective = load_asset_module(
        repo,
        "test/Board/Support/wafer_collective_hardware_characterization_catalog.py",
        cache,
    )
    assert all(
    ...
    engine = load_asset_module(
        repo,
        "test/Board/Support/wafer_engine_pipeline_characterization_catalog.py",
        cache,
    )
    ...
    ne = load_asset_module(
        repo, "test/Board/Support/wafer_ne_calibration_catalog.py", cache
    )
    ne_i8 = tuple(
        case
    ...
    instruction = load_asset_module(
        repo, "test/Board/Support/wafer_instruction_family_catalog.py", cache
    )

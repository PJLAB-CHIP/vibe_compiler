...
declare void @wafer_tx81_ncc_execution_probe(i64, i64, i64)
declare i32 @__get_pid(i32)

@wafer_ncc_slots_per_tile = external hidden constant i64
...
run:
  ...
  %slots_per_tile = load i64, ptr @wafer_ncc_slots_per_tile, align 8
  ...
  call void @wafer_tx81_ncc_execution_probe(i64 %request, i64 %payload, i64 %output)
  br label %done

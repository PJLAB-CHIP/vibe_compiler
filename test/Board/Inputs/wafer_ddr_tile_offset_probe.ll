...
entry:
  ...
  %input0.slot = getelementptr inbounds i64, ptr %tile_major_slots, i64 %input0.index
  %input1.slot = getelementptr inbounds i64, ptr %tile_major_slots, i64 %input1.index
  %output0.slot = getelementptr inbounds i64, ptr %tile_major_slots, i64 %output0.index
  %output1.slot = getelementptr inbounds i64, ptr %tile_major_slots, i64 %output1.index

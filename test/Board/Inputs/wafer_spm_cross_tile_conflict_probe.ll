...
entry:
  ...
  %request.slot = getelementptr inbounds i64, ptr %rank_major_slots, i64 %request.index
  %payload.slot = getelementptr inbounds i64, ptr %rank_major_slots, i64 %payload.index
  %serial.slot = getelementptr inbounds i64, ptr %rank_major_slots, i64 %serial.index
  %window.slot = getelementptr inbounds i64, ptr %rank_major_slots, i64 %window.index

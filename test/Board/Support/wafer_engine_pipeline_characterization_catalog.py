...
- User-level driver / named pipeline:
  ``wafer_board_engine_pipeline_characterization_runner.py`` reuses the normal
...
RAW_PROBE_ASSET = "test/Board/Support/wafer_board_ncc_execution_probe_runner.py"
MEMORY_PAIR_ASSET = (
    "test/Board/Support/wafer_memory_descriptor_calibration_catalog.py"
)
NE_CALIBRATION_ASSET = "test/Board/Support/wafer_ne_calibration_catalog.py"
NE_TAIL_THROUGHPUT_ASSET = (
    "test/Board/Support/wafer_ne_tail_throughput_catalog.py"
)
...
PIPELINE_CONTRACT = PipelineContract(
    ...
    user_level_driver=(
        "wafer_board_engine_pipeline_characterization_runner.py"
    ),
    explicit_non_goals=(

...
NCC_EXECUTION = (
    ...
    "test/Board/Support/wafer_ncc_probe_protocol.py",
)
INSTRUCTION_FAMILY = (
    "test/Board/Support/wafer_board_instruction_family_probe_runner.py",
...
CT_VECTOR_CALIBRATION = (
    "test/Board/Support/wafer_board_ct_vector_calibration_probe_runner.py",
    "test/Board/Support/wafer_ct_vector_calibration_catalog.py",
...
CT_CONVERT_CALIBRATION = (
    "test/Board/Support/wafer_board_ct_convert_calibration_probe_runner.py",
    "test/Board/Support/wafer_ct_convert_calibration_catalog.py",
...
CT_OPCODE_DISPOSITIONS = (
    "test/Board/Support/wafer_ct_opcode_disposition_catalog.py",
    "test/Board/Cases/wafer_ct_opcode_disposition_catalog_test.py",
)
DATAMOVE_CALIBRATION = (
    "test/Board/Support/wafer_board_datamove_calibration_probe_runner.py",
    "test/Board/Support/wafer_datamove_calibration_catalog.py",
...
DATAMOVE_EXTENDED_CALIBRATION = (
    "test/Board/Support/wafer_board_datamove_extended_calibration_probe_runner.py",
    "test/Board/Support/wafer_datamove_extended_calibration_catalog.py",
...
PHYSICAL_TENSOR_CODEC = (
    "test/Board/Support/wafer_physical_tensor_codec.py",
    "test/Board/Cases/wafer_physical_tensor_codec_test.py",
)
NE_CALIBRATION = (
    "test/Board/Support/wafer_board_ne_calibration_probe_runner.py",
    "test/Board/Support/wafer_ne_calibration_catalog.py",
...
CACHE_COHERENCE_CALIBRATION = (
    "test/Board/Support/wafer_board_cache_coherence_calibration_probe_runner.py",
    "test/Board/Support/wafer_cache_coherence_calibration_catalog.py",
...
MEMORY_DESCRIPTOR_CALIBRATION = (
    "test/Board/Support/wafer_board_memory_descriptor_calibration_probe_runner.py",
    "test/Board/Support/wafer_memory_descriptor_calibration_catalog.py",
...
TRANSPORT_PMU_CALIBRATION = (
    ...
    "test/Board/Cases/wafer_transport_pmu_calibration_catalog_test.py",
)
...
INSTRUCTION_CATALOG = "test/Board/Support/wafer_instruction_family_catalog.py"
CT_VECTOR_CATALOG = "test/Board/Support/wafer_ct_vector_calibration_catalog.py"
CT_CONVERT_CATALOG = "test/Board/Support/wafer_ct_convert_calibration_catalog.py"
CT_DISPOSITION_CATALOG = (
    "test/Board/Support/wafer_ct_opcode_disposition_catalog.py"
)
DATAMOVE_CATALOG = "test/Board/Support/wafer_datamove_calibration_catalog.py"
DATAMOVE_EXTENDED_CATALOG = (
    "test/Board/Support/wafer_datamove_extended_calibration_catalog.py"
)
NE_CATALOG = "test/Board/Support/wafer_ne_calibration_catalog.py"
SPM_CATALOG = "test/Board/Support/wafer_spm_calibration_catalog.py"
CACHE_CATALOG = "test/Board/Support/wafer_cache_coherence_calibration_catalog.py"
MEMORY_DESCRIPTOR_CATALOG = (
    "test/Board/Support/wafer_memory_descriptor_calibration_catalog.py"
)
NCC_CATALOG = "test/Board/Support/wafer_board_ncc_execution_probe_runner.py"
DTE_NCC_CATALOG = (
    "test/Board/Support/wafer_transport_pmu_calibration_catalog.py"
)
BARRIER_CATALOG = "test/Board/Support/wafer_board_complete_tile_barrier_probe_runner.py"
...
CALIBRATION_DOMAINS = (
    ...
    _domain(
        ...
        negative=(
            "test/Board/Support/wafer_datamove_calibration_catalog.py",
            "test/Board/Cases/wafer_datamove_calibration_catalog_test.py",
        ),
        tests=(
    ...
    _domain(
        ...
        positive=NCC_EXECUTION,
        negative=("test/Board/Cases/wafer_ncc_probe_protocol_test.py",),
        tests=(
            "wafer-ncc-probe-protocol-python",
            "wafer-runtime-ncc-safe-observations-no-card",
        ),
    ...
    _domain(
        ...
        negative=(
            "test/Board/Support/wafer_spm_calibration_catalog.py",
            "test/Board/Cases/wafer_spm_calibration_catalog_test.py",
        ),
        tests=(
    ...
    _domain(
        ...
        positive=NCC_EXECUTION,
        negative=(
            "test/Board/Cases/wafer_ncc_hazard_relation_test.c",
    ...
    _domain(
        ...
        negative=(
            "test/Board/Cases/wafer_complete_tile_barrier_contract_test.py",
            "test/Board/Support/wafer_board_complete_tile_barrier_probe_runner.py",
        ),
        tests=(
    ...
    _domain(
        ...
        "static-negative",
        negative=(
            "test/Board/Cases/wafer_ncc_probe_protocol_test.py",
            "test/Board/Inputs/wafer_ncc_execution_probe.c",
        ),

// RUN: wafer-opt --pass-pipeline='builtin.module(wafer-lower-groups-to-abi-calls)' %s | FileCheck %s
...
// CHECK-LABEL: func.func @boundary_tiled_matmul_group_abi
// CHECK-NOT: wafer.group
// CHECK-NOT: wafer.tile.region
// CHECK-NOT: wafer.instr
// CHECK: call @wafer_rdma
// CHECK: call @wafer_rdma
// CHECK: call @wafer_gather_scatter
// CHECK: call @wafer_gather_scatter
// CHECK: call @wafer_gemm
// CHECK: call @wafer_gather_scatter
// CHECK: call @wafer_wdma
// CHECK-DAG: func.func private @wafer_rdma
// CHECK-DAG: func.func private @wafer_gather_scatter
// CHECK-DAG: func.func private @wafer_gemm
// CHECK-DAG: func.func private @wafer_wdma

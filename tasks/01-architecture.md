...
5. production planning不物化CardModule loser；只有selected winner构造一次actual CardModule，commit失败报告planning/lowering
   合同缺口，不返回candidate set继续尝试；allocator、completion、communication和cost owner均不产生repair；

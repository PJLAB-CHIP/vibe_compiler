...
- 没有 placed instruction-level IR、placed memref 或 access descriptor 层；下一步由 R3.2e
  candidate DDR tile-view producer、R3.2d instruction legalization consumer 和 R3.2f SPM placement

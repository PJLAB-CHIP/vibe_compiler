...
| Candidate decision | `tasks/2026-06-11-wafer-r3-2h-candidate-decision-design.md` | 草案 | traversal tile shape、layout choice、internal split、output coverage、R3.2e-g gates、`tile_search` 选择策略、passing candidate artifact | 新 allocator、失败计划 IR、runtime allocation/import、packet bitfield |

...
residency 和 bandwidth 设计见 `tasks/2026-05-25-wafer-ddr-memory-planning-design.md`。
...
| Candidate decision / committed materialization | `tasks/2026-06-11-wafer-r3-2h-candidate-decision-design.md`、`tasks/2026-06-11-wafer-committed-candidate-materialization-design.md` | R3.2h/R3.3 V0 已实现 | shape-driven traversal/reduction refinement frontier、same-domain output coverage、matmul/generic reduction split、representative tile classes、candidate gates、`tile-search` 选择策略、selected candidate commit 回主 IR | 新 allocator、失败计划 IR、runtime allocation/import、packet bitfield、不同 output domain 或 dynamic reduction 伪支持 |

...
结论：主方向仍然成立，即 verified StableHLO / MLIR program、Shardy/SPMD 和 Wafer
...
- 不从历史 backend 反推整体架构。
- verified StableHLO / MLIR program、Shardy/SPMD 和 Wafer IR contract 是合理主路径；具体

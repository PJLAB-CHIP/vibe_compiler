...
- Q62 Target数值合同重建记录：`tasks/archive/target-numeric-contract-reconstruction.md`；稳定target operation、
  materialization、model/evidence与源码边界由01、11、14、16-18拥有。
- Q63 NCC completion合同分层记录：`tasks/archive/ncc-synchronization-contract-layering.md`；稳定Instr、communication、
  model和MLIR adapter边界由11、13、17-19拥有。
- 源码布局收敛记录：`tasks/archive/source-layout-consolidation.md`；稳定source/library规则由18拥有，MLIR component规则由19拥有。

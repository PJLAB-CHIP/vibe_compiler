...
| Q21 | `single-card-tiny-llama` | `doing` | Q20 | tiny Llama decoder block经同一16-rank candidate/bundle/package/reference路径；先以真实source gate定位当前unsupported IR/geometry，再沿正式pipeline补齐；不接受手工group/instr或绕过selector的平行主线。 | 01、05、06、10、11、13、16 |

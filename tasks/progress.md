...
| Q19 | `reference-executor-core` | `doing` | Q16 | 已落owner-backed immutable `ReferenceProgram`和执行前capability preflight：当前alloc/dealloc/cast/static subview/reinterpret、tile-region、movement、GEMM、elementwise/fill/fence/return逐op投影成value-id command，执行期不读mutable MLIR；原IR mutation和unsupported-before-input gate已通过。仍需补SCF/CFG/direct-call、convert/rounding、完整capability矩阵、非平凡differential及独立layout property oracle。 | 10、11、16 |

...
| 2 | `production-host-readiness` | `queued` | Q53 / 16 | item 1 的 current-IR 与 target-independent/target transport 分界、frontend、interface、package/runtime | 通信与架构修改后的 fresh source/IR/package/oracle/runner/no-card/SystemC 矩阵通过；本项不运行真实设备 | `tasks/plans/physical-dataflow-synthesis.md` |

...
| Q20 | `single-card-linear-mlp` | `doing` | Q5.C、Q19.M | 同一driver分别以rank-count=1和16生成完整bundle、manifest和runtime trace，并由reference executor与独立NumPy CPU reference比较；rank-count=1不能用手写group gate代替。 | 01、16 |

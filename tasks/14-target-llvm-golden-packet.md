...
| transpose-like TDMA transform group | no production Wafer symbol in V0 | mirror/transpose/rotate/NCHW-NHWC/TensorNom wrappers exist but are not default lowering surface | compiler lowering must have materialized these movements before instruction IR; future native enablement requires board/golden coverage and an explicit verifier update |

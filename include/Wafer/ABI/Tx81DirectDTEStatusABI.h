...
/*
 * V1 exposed a four-byte, four-byte-aligned status allocation.  V2 keeps the
 * uint32_t value at offset zero but owns one complete TX81 cache line so the
 * Kcore clean-and-invalidate publication cannot touch another resource.
 */
#define WAFER_TX81_DIRECT_DTE_STATUS_ABI_V1                                 \
  "wafer-direct-dte-status-v1"
#define WAFER_TX81_DIRECT_DTE_STATUS_ABI_V2                                 \
...
#define WAFER_TX81_DIRECT_DTE_STATUS_V2_VALUE_OFFSET 0U
#define WAFER_TX81_DIRECT_DTE_STATUS_V2_VALUE_BYTES 4U
#define WAFER_TX81_DIRECT_DTE_STATUS_V2_STORAGE_BYTES 64U
#define WAFER_TX81_DIRECT_DTE_STATUS_V2_STORAGE_ALIGNMENT 64U
#define WAFER_TX81_DIRECT_DTE_STATUS_V2_CACHE_LINE_BYTES 64U

#if WAFER_TX81_DIRECT_DTE_STATUS_V2_VALUE_OFFSET != 0
#error "TX81 Direct DTE status value must remain at offset zero"
#endif

#if WAFER_TX81_DIRECT_DTE_STATUS_V2_STORAGE_BYTES !=                       \
    WAFER_TX81_DIRECT_DTE_STATUS_V2_CACHE_LINE_BYTES
#error "TX81 Direct DTE status storage must own exactly one cache line"
#endif

#if WAFER_TX81_DIRECT_DTE_STATUS_V2_STORAGE_ALIGNMENT !=                   \
    WAFER_TX81_DIRECT_DTE_STATUS_V2_CACHE_LINE_BYTES
#error "TX81 Direct DTE status storage must be cache-line aligned"
#endif

#if WAFER_TX81_DIRECT_DTE_STATUS_V2_VALUE_OFFSET +                         \
...
#if (WAFER_TX81_DIRECT_DTE_STATUS_V2_STORAGE_ALIGNMENT &                   \
     (WAFER_TX81_DIRECT_DTE_STATUS_V2_STORAGE_ALIGNMENT - 1)) != 0

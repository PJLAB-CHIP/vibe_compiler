//===- LayoutPlanningAnalysis.h - Scheduling layout analysis -*- C++
//-*-===//

#ifndef WAFER_ANALYSIS_SCHEDULING_LAYOUTPLANNINGANALYSIS_H
#define WAFER_ANALYSIS_SCHEDULING_LAYOUTPLANNINGANALYSIS_H
...
/// Layout plan for a standalone structured scheduling function. Boundary
/// ownership is described by the explicit input/output argument partition,
/// not by a container op.
struct StructuredSchedulingLayoutPlan {
...
mlir::LogicalResult
collectStructuredSchedulingLayoutPlan(mlir::func::FuncOp function,
                                      unsigned inputCount,
                                      StructuredSchedulingLayoutPlan &plan);

} // namespace wafer

#endif // WAFER_ANALYSIS_SCHEDULING_LAYOUTPLANNINGANALYSIS_H

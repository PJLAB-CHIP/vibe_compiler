...
#ifndef WAFER_ANALYSIS_LINALG_STRUCTUREDDAGANALYSIS_H
#define WAFER_ANALYSIS_LINALG_STRUCTUREDDAGANALYSIS_H
...
/// Current-IR lookup from one structured operation to its DAG node. The
/// operation pointer is valid only for the unchanged function analyzed by the
/// owning StructuredDAGAnalysis.
...
#endif // WAFER_ANALYSIS_LINALG_STRUCTUREDDAGANALYSIS_H

...
REQUIRED_ADAPTER_SYMBOLS = (
    ...
    "calibrateOneDNNBackend",
    "freezeOneDNNBackendPolicy",
    "validateOneDNNBackend",
)
...
def main() -> int:
    ...
    try:
        ...
        if forbidden or missing_raw or missing_adapters:
            raise RuntimeError(
                "onednn feature-on link closure mismatch: "
        ...
        return 1
    print("onednn feature-on link closure passed: static oneDNN, SEQ runtime")
    return 0

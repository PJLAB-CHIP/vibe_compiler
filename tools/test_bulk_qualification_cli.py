#!/usr/bin/env python3
"""End-to-end smoke for the no-replace bulk qualification CLI."""
...
def main() -> int:
    ...
    temporary = pathlib.Path(
        tempfile.mkdtemp(prefix="bulk-cli-", dir=args.work_root.resolve())
    )
    try:
        base = {
    ...
    print("bulk qualification CLI calibrate/freeze/validate/readback passed")
    return 0

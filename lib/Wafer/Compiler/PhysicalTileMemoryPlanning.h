//===- PhysicalTileMemoryPlanning.h - Physical Tile memory planning -*- C++
//-*-===//

#ifndef WAFER_COMPILER_PHYSICALTILEMEMORYPLANNING_H
#define WAFER_COMPILER_PHYSICALTILEMEMORYPLANNING_H
...
enum class PhysicalTileMemoryPlanningFailureKind : uint8_t {
  None,
  Contract,
...
/// Typed, invocation-local rejection evidence for one physical-Tile module.
/// It never carries a partially placed module.
struct PhysicalTileMemoryPlanningFailure {
  PhysicalTileMemoryPlanningFailureKind kind =
      PhysicalTileMemoryPlanningFailureKind::None;
...
/// resulting physical-Tile module.
...
mlir::FailureOr<mlir::OwningOpRef<mlir::ModuleOp>> planPhysicalTileMemory(
    ...
    PhysicalTileMemoryPlanningFailure *failure = nullptr,
...
#endif // WAFER_COMPILER_PHYSICALTILEMEMORYPLANNING_H

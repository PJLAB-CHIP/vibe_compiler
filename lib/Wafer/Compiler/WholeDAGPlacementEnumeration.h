//===- WholeDAGPlacementEnumeration.h - Joint node placement -------*- C++
//-*-===//
...
struct WholeDAGPlacementEnumerationStatistics {
...
enumerateWholeDAGPlacements(
    const CardDAGAnalysis &dag, const PhysicalTopology &topology,
    PhysicalCardId cardId,
    WholeDAGPlacementEnumerationStatistics *statistics = nullptr,
    std::string *failureReason = nullptr);

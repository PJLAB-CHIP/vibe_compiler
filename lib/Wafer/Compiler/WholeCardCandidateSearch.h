//===- WholeCardCandidateSearch.h - Whole-card Tile candidates -*- C++ -*-===//

#ifndef WAFER_COMPILER_WHOLECARDCANDIDATESEARCH_H
#define WAFER_COMPILER_WHOLECARDCANDIDATESEARCH_H
...
using WholeCardTileCandidateSet = std::vector<CoordinatedTileVariant>;
...
struct WholeCardCandidateSearchConfig {
  int64_t rankCount = 0;
...
class WholeCardCandidateSearchSession {
public:
  static mlir::FailureOr<std::unique_ptr<WholeCardCandidateSearchSession>>
  ...
  ~WholeCardCandidateSearchSession();
  WholeCardCandidateSearchSession(WholeCardCandidateSearchSession &&) noexcept;
  WholeCardCandidateSearchSession &
  operator=(WholeCardCandidateSearchSession &&) noexcept;
  WholeCardCandidateSearchSession(const WholeCardCandidateSearchSession &) =
      delete;
  WholeCardCandidateSearchSession &
  operator=(const WholeCardCandidateSearchSession &) = delete;
...
private:
  struct Impl;
  explicit WholeCardCandidateSearchSession(std::unique_ptr<Impl> impl);
...
#endif // WAFER_COMPILER_WHOLECARDCANDIDATESEARCH_H

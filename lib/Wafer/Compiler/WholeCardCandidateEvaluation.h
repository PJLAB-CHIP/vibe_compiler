//===- WholeCardCandidateEvaluation.h - Evaluate whole-card candidates --===//

#ifndef WAFER_COMPILER_WHOLECARDCANDIDATEEVALUATION_H
#define WAFER_COMPILER_WHOLECARDCANDIDATEEVALUATION_H
...
enum class WholeCardInstrLoweringFailureKind : uint8_t {
  None,
  RankDomain,
  RankInstrLowering,
  SPMAllocation,
...
struct WholeCardInstrLoweringFailure {
  WholeCardInstrLoweringFailureKind kind =
      WholeCardInstrLoweringFailureKind::None;
  int64_t logicalRank = -1;
  std::string gate;
};

struct EvaluatedWholeCardCandidate {
  EvaluatedWholeCardCandidate(int64_t stableSemanticOrdinal,
                              bool reservedBaseline,
                              WholeCardExecutableResult variant,
  ...
  EvaluatedWholeCardCandidate(EvaluatedWholeCardCandidate &&) noexcept =
      default;
  EvaluatedWholeCardCandidate &
  operator=(EvaluatedWholeCardCandidate &&) noexcept = default;
  EvaluatedWholeCardCandidate(const EvaluatedWholeCardCandidate &) = delete;
  EvaluatedWholeCardCandidate &
  operator=(const EvaluatedWholeCardCandidate &) = delete;
...
enum class WholeCardCandidateEvaluationStepKind : uint8_t {
  Accepted,
  RecoverableRejected,
  Exhausted,
};

enum class WholeCardCandidateEvaluationLane : uint8_t {
  Seed,
  Expansion,
};
...
class WholeCardCandidateEvaluationScheduler {
public:
  ...
  mlir::LogicalResult recordAttempt(WholeCardCandidateEvaluationLane lane,
                                    bool exactAccepted);
...
struct WholeCardCandidateEvaluationStep {
  WholeCardCandidateEvaluationStepKind kind =
      WholeCardCandidateEvaluationStepKind::Exhausted;
  std::optional<EvaluatedWholeCardCandidate> candidate;
...
class WholeCardCandidateEvaluationCursor {
public:
  ~WholeCardCandidateEvaluationCursor();
  WholeCardCandidateEvaluationCursor(
      WholeCardCandidateEvaluationCursor &&) noexcept;
  WholeCardCandidateEvaluationCursor &
  operator=(WholeCardCandidateEvaluationCursor &&) noexcept;
  WholeCardCandidateEvaluationCursor(
      const WholeCardCandidateEvaluationCursor &) = delete;
  WholeCardCandidateEvaluationCursor &
  operator=(const WholeCardCandidateEvaluationCursor &) = delete;
...
private:
  struct Impl;
  explicit WholeCardCandidateEvaluationCursor(std::unique_ptr<Impl> impl);
  std::unique_ptr<Impl> impl;

  friend mlir::FailureOr<std::unique_ptr<WholeCardCandidateEvaluationCursor>>
  beginWholeCardCandidateEvaluation(
      ...
      WholeCardInstrLoweringFailure &, WholeVariantSelectionStatistics *,
      WholeVariantSelectionMode, unsigned,
      llvm::ArrayRef<const CoordinatedCommunicationActionProvider *>);
  friend mlir::FailureOr<WholeCardCandidateEvaluationStep>
  advanceWholeCardCandidateEvaluation(WholeCardCandidateEvaluationCursor &,
...
advanceWholeCardCandidateEvaluation(WholeCardCandidateEvaluationCursor &cursor,
...
#endif // WAFER_COMPILER_WHOLECARDCANDIDATEEVALUATION_H

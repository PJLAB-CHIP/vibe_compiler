...
find_program(CMAKE_ASM_COMPILER ${CROSS_COMPILE}${ASM} PATHS ${TOOLCHAIN_HOME} NO_DEFAULT_PATH)
...
find_program(CMAKE_CXX_COMPILER ${cplusplus_compiler} HINTS ${TOOLCHAIN_HOME} NO_DEFAULT_PATH)
...
include(${TX8FW_BASE}/cmake/gcc-m-cpu.cmake OPTIONAL)
include(${TX8FW_BASE}/cmake/gcc-m-fpu.cmake OPTIONAL)

if("${ARCH}" STREQUAL "arm")
  include(${TX8FW_BASE}/cmake/compiler/gcc/target_arm.cmake)
elseif("${ARCH}" STREQUAL "arm64")
  include(${TX8FW_BASE}/cmake/compiler/gcc/target_arm64.cmake)
elseif("${ARCH}" STREQUAL "arc")
  include(${TX8FW_BASE}/cmake/compiler/gcc/target_arc.cmake)

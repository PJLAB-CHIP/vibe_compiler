...
if(NOT "${TX8FW_TOOLCHAIN_VARIANT}" STREQUAL "host")
  ...
  if(CONFIG_CMAKE_LINKER_GENERATOR)
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND}
        ...
        -P ${TX8FW_BASE}/cmake/linker/ld/ld_script.cmake
      )
  else()
...
include(${TX8FW_BASE}/cmake/linker/${LINKER}/target_base.cmake)
include(${TX8FW_BASE}/cmake/linker/${LINKER}/target_baremetal.cmake)
include(${TX8FW_BASE}/cmake/linker/${LINKER}/target_cpp.cmake)
include(${TX8FW_BASE}/cmake/linker/${LINKER}/target_relocation.cmake)
include(${TX8FW_BASE}/cmake/linker/${LINKER}/target_configure.cmake)

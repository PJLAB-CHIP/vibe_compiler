...
#   maintainers in ``${TX8FW_BASE}/VERSION``
#
...
# determine this RTThread package version and thus the correct RTThread CMake
# package to load.
...
include(${TX8FW_BASE}/cmake/modules/hex.cmake)

if(NOT DEFINED VERSION_FILE AND NOT DEFINED VERSION_TYPE)
  set(VERSION_FILE ${TX8FW_BASE}/VERSION ${APPLICATION_SOURCE_DIR}/VERSION)
...
foreach(type file IN ZIP_LISTS VERSION_TYPE VERSION_FILE)
  ...
  if(type STREQUAL KERNEL)
    ...
    set(RTTHREAD_VERSION_CODE ${${type}_VERSION_NUMBER_INT})
    set(RTTHREAD_VERSION TRUE)
    ...
    if (NOT NO_PRINT_VERSION)
        message(STATUS "RTThread version: ${PROJECT_VERSION_STR} (${TX8FW_BASE})${BUILD_VERSION_STR}")
    endif()
  endif()

...
# This CMake module will load all RTThread CMake modules in correct order for
# default RTThread build system.
#
# Outcome:
...
if(${CMAKE_VERSION} VERSION_EQUAL 3.22.1 OR ${CMAKE_VERSION} VERSION_EQUAL 3.22.2)
  ...
  cmake_path(GET TX8FW_BASE PARENT_PATH test_cmake_path)
  if(TX8FW_BASE STREQUAL test_cmake_path)
...
list(APPEND zephyr_cmake_modules utility)


# Load RTThread extensions
...
foreach(component ${SUB_COMPONENTS})
  if(NOT ${component} IN_LIST zephyr_cmake_modules)
    message(FATAL_ERROR
      "Subcomponent '${component}' not default module for RTThread CMake build system.\n"
...
foreach(module IN LISTS zephyr_cmake_modules)
  ...
  if(DEFINED SUB_COMPONENTS AND NOT SUB_COMPONENTS)
    # All requested RTThread CMake modules have been loaded, so let's return.
    return()
  endif()
endforeach()

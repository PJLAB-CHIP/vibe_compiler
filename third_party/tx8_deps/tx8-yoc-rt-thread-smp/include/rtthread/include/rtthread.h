...
void rt_memory_info(rt_size_t *total,
                    rt_size_t *used,
                    rt_size_t *max_used);
#include "rtthread_tx8_patch.inc"
...
rt_smem_t rt_smem_init_tx81(const char    *name,
                            void          *begin_addr,
                            rt_size_t      size);
void *rt_smem_alloc_tx81(rt_smem_t m, rt_size_t size);
void *rt_smem_realloc_tx81(rt_smem_t m, void *rmem, rt_size_t newsize);
void rt_smem_free_tx81(void *rmem);

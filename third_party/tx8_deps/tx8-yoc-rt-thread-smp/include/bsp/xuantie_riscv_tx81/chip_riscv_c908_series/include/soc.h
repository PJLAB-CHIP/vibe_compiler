...
#elif  CONFIG_BOARD_SMARTH_EVB_FOR_TX81
    #define DW_UART0_BASE            (CONFIG_UART_BASE_ADDR)
    #define  UART_CLK                (100000000)
    #define  CORE_TIMER_CLK          (100000000)
    #define  SCT_SCONF_BASE          (0x500000UL)
    #define  KCORE_CTRL              (SCT_SCONF_BASE + 0x230UL)
#else

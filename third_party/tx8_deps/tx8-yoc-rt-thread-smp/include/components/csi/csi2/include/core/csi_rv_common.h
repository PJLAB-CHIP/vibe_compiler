...
#define csr_read              rv_csr_read
#define csr_write             rv_csr_write
#define csr_read_set          rv_csr_read_set
#define csr_set               rv_csr_set
#define csr_read_clear        rv_csr_read_clear
#define csr_clear             rv_csr_clear

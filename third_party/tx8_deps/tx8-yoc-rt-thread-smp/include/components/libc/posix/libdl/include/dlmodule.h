...
typedef void (*rt_dlmodule_init_func_t)(void*);
typedef void (*rt_dlmodule_cleanup_func_t)(void*);
...
struct rt_dlmodule
{
    ...
    rt_list_t dependence_module_list;
    ...
    rt_uint8_t  system_component_flag;
    rt_uint32_t nsym;       /* number of symbols in the module */
...
rt_uint64_t dlmodule_symbol_find(struct rt_dlmodule *module,const char *sym_str);
int get_module_name_from_path(const char *path,const char** first_of_name);
void dlmodule_set_name(struct rt_dlmodule *module, const char *path);
void add_to_system_component_list(struct rt_dlmodule * module);
void remove_from_system_component_list(struct rt_dlmodule * module);
#endif
